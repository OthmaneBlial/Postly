...
- [ ] Effectuer les validations sur les machines cibles non macOS et joindre un rapport par plateforme ; aucune compatibilité Windows/Linux/Intel n'est déduite du build ARM64. La compilation CLI Linux/Windows passe désormais via Zig sur macOS, mais le lien release Linux, le packaging GUI et les runtimes restent ouverts ; les preuves et échecs sont consignés dans [le rapport de plateforme](docs/measurements/2026-09-08-cross-platform.md).
