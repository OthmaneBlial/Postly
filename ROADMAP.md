...
- [x] Rejouer l'archive dans un environnement utilisateur isolé sans Cargo ni Node ; version, workspace, API locale, checksums et démarrage GUI passent. Le replay est codifié dans [tools/replay-package.sh](tools/replay-package.sh) et prouvé dans [la mesure isolée](docs/measurements/2026-09-08-isolated-package.md).
