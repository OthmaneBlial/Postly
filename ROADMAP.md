...
- [ ] Effectuer les validations sur les machines cibles non macOS et joindre un rapport par plateforme ; aucune compatibilité Windows/Linux/Intel n'est déduite du build ARM64. La tentative cross-target locale et ses prérequis manquants sont consignés dans [le rapport de plateforme](docs/measurements/2026-09-08-cross-platform.md).
