...
- [ ] Effectuer les validations sur les machines cibles non macOS et joindre un rapport par plateforme ; aucune compatibilité Windows/Linux/Intel n'est déduite du build ARM64. La compilation CLI Linux/Windows et les liens release Linux (ELF x64) et Windows (PE32+ x64 via MinGW) passent désormais sur macOS, mais le packaging/runtimes cibles et la machine Intel restent ouverts ; les preuves sont consignées dans [le rapport de plateforme](docs/measurements/2026-09-08-cross-platform.md).
