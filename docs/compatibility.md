...
| Native response viewer | working GUI slice with JSON/YAML/XML formatting and detected lightweight JSON/YAML/XML/HTML/JavaScript/Text previews | virtualized line rows, format detection, search, copy, local save and wrapping |
