...
| Server-Sent Events | CLI and native GUI streaming slice with cancellation; bounded CLI reconnects and `Last-Event-ID`, GUI reconnect pending | chunked parser tests, local streaming/reconnect CLI integration tests and GUI worker/cancellation tests |
