...
| Explicit response assertions | working core/runner and native GUI editor slice | exact/ranged status, present/equal/containing headers and cookies, valid JSON body, body text, response-time threshold, JSON Pointer presence/equality runner integration test and GUI editor round-trip |
