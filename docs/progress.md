...
- Persistable response assertions for exact/ranged status, present/equal/containing headers, body text, response-time thresholds and JSON Pointer presence/equality, evaluated by the runner without Node.js.
