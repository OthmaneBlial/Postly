...
`f335e10d6c64ad35caf7ba2538db33d44643ee69c1eca76be2cd6e4b531d1126`.
...
execution metadata plus the request-cookie `pm.cookies` snapshot; the CLI, HTTP
core, runner and script loopback tests remain covered in the workspace suite.
