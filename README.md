...
- Progressive Server-Sent Events subscriptions from the CLI and native GUI with chunk-safe event parsing, bounded event history, JSON-lines output and bounded CLI reconnects with `Last-Event-ID`.
